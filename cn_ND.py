...
trn_df = pd.read_csv(DATA_DIR / 'dch2_train_trn-cn.csv', usecols=('label', 'text'))
...
tst_df = pd.read_csv(DATA_DIR / 'dch2_test_trn-cn.csv', usecols=('text', 'id', 'sender'))
...
# torch.save(dls, DATA_DIR / f'dls-trn_a-b{trn_bs}.pth')

# dls = torch.load(DATA_DIR / f'dls-trn_a-b{trn_bs}.pth')
